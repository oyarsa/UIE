...
class Span:
    ...
    def get_empty_span(
        ...
        return Span(tokens=list(), indexes=list(), text="", text_id=text_id)
    ...
    def to_offset(self, ent_label_mapper=None):
        ...
        return {
            "type": change_name_using_label_mapper(
                self.label.label_name, ent_label_mapper
            ),
...
class Relation(Record):
    ...
    def to_offset(self, rel_label_mapper=None, ent_label_mapper=None):
        ...
        return {
            "type": change_name_using_label_mapper(
                self.label.label_name, rel_label_mapper
            ),
            "args": [
                self.arg1.to_offset(ent_label_mapper=ent_label_mapper),
...
class Event(Record):
    ...
    def to_offset(self, evt_label_mapper=None):
        ...
        return {
            "type": change_name_using_label_mapper(
                self.label.label_name, evt_label_mapper
            ),
            "offset": self.span.indexes,
            "text": self.span.text,
            "args": args,
...
class Sentence:
    def __init__(
        ...
        text_id: Optional[Union[str, None]] = None,
    ) -> None:
        self.tokens = tokens
    ...
    def count_entity_without_relation(self):
        ...
        for relation in self.relations:
            entity1 = (
                tuple(relation.arg1.span.indexes),
                relation.arg1.label.label_name,
            )
            entity2 = (
                tuple(relation.arg2.span.indexes),
                relation.arg2.label.label_name,
            )
